                ...
                <div className="main">
                    ...
                    <section className="main-section" id="work">
                        ...
                        <div className="main-work-gallery">
                            ...
                            <PortfolioItem
                                href={
                                    'https://www.competitivecyclist.com/sc/road-bike-guide'
                                }
                                src={rbbgImage}
                                title={
                                    <h3>
                                        Competitive Cyclist<br />Road Bike
                                        Buyer's Guide
                                    </h3>
                                }
                            ...
                            <PortfolioItem
                                href={
                                    'https://www.competitivecyclist.com/sc/jacket-buyers-guide'
                                }
                                src={jacketImage}
                                title={
                                    <h3>
                                        Competitive Cyclist<br />Jacket Guide
                                    </h3>
                                }
                                alt="CC jacket Guide"
                            />
                            <PortfolioItem
                                href={
                                    'https://www.competitivecyclist.com/sc/andiamo'
                                }
                                src={andiamoImage}
                                title={
                                    <h3>
                                        Competitive Cyclist<br />Andiamo
                                    </h3>
                                }
